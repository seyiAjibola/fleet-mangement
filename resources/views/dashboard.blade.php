                ...
                <div class="grid gap-6 px-6 py-8 lg:grid-cols-[1.35fr,0.65fr] lg:px-8">
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="max-w-2xl text-sm leading-6 text-stone-600">
                                Use the admin workspace to manage suppliers, vehicles, drivers, bookings, and reports without leaving the current session.
                            </p>
                        </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                        <div class="rounded-2xl border border-stone-200 bg-stone-50 p-5">
                            ...
                            <p class="mt-2 text-sm text-stone-700">Authenticated session is active and ready for admin operations.</p>
                        </div>
                        <div class="rounded-2xl border border-stone-200 bg-amber-50 p-5">
                            ...
                            <p class="mt-2 text-sm text-amber-800">Go to the admin dashboard to continue managing fleet and booking workflows.</p>
                        </div>
                    </div>
                </div>
            </div>
