<section>
    ...
    <form class="form-card" wire:submit.prevent="save">
        ...
        <div class="form-row">
            ...
            <small style="color: var(--muted);">Score is calculated automatically from active status, compliance documents, website presence, social presence, years in business, and fleet size.</small>
        </div>

        <div class="form-row">
            <label for="supplier_tier">Supplier Tier</label>
            <input id="supplier_tier" type="text" value="{{ ucfirst($this->previewTier()) }}" readonly />
            <small style="color: var(--muted);">Tier is assigned automatically from supplier score, years in business, compliance documents, active status, and fleet size.</small>
        </div>
